...
<?php  
  ...
  { 
   ...
   print(" <legend align=center style=color:blue;><b>INFORM PATIENT</b></legend>");
   for ($i=1; $i < $count ; $i++) 
   { 
    $Error="";
    if ($Message[$i]==0) 
          ...
          <fieldset>
                   ...
                   <div align=left style=float:left;>
                     ...
                     <hr>
                      ...
                      <div>
                        <button type=submit class=button  name=Login >Done</button>
                      </div>
                   </div>
           <div>
...
{ 
  if(isset(($_POST['Login'])))
  {
    ...
    echo '<script type="text/javascript">window.location.href="Send_Message_confirmation .php";</script>';
  }
}
?>